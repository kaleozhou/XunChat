...
import com.cn.ouan.xunchat.WelcomeActivity;
import com.cn.ouan.xunchat.util.ConnectionLog;
...
public class PushService extends Service {
	...
	private static final String MQTT_HOST = "192.168.1.112";
	...
	// Notification title
	public static String NOTIF_TITLE = "chat";
	// Notification id
...
//		intent.putExtra("type", type);
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public void publishArrived(String topicName, byte[] payload, int qos,
			...
			Log.i("push", dataJSON.toString());
			showNotification(dataJSON.toString());
			Intent i=new Intent(Constants.ACTION_PUSH_CHAT_MESSAGE);
			i.putExtra("chatmessage", dataJSON.toString());
			sendBroadcast(i);
 		}
